...
export const overlayDefaultsMap: Record<string, Record<string, any>> = {
  ...
  electric_gift_alert: { trigger: "any_gift", min_coins: 1, duration: 4, ring_color: "180 100% 50%", particles: true, electric_shards: true, ring_count: "3", name_size: 26, show_tier: true, show_coins: true, position: "center", queue: true, transparent_bg: true, scanlines: true, corner_accents: true, anim_speed: 1, glow_intensity: 80, custom_css: "" },
};
