  ...
  return (
    <AppLayout>
      <div className="max-w-[1400px] mx-auto relative z-10 pb-12">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-44 bg-muted/50 border border-border rounded-lg pl-8 pr-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 outline-none focus:ring-1 focus:ring-primary/30 disabled:opacity-50 transition-all"
                    />
                  </div>
                  <button
                    onClick={handleConnect}
                    disabled={connectionStatus === "connecting"}
                    className="px-5 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-bold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2"
                  >
        ...
        {/* ─── WHAT'S NEW + DISCORD side by side ─── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          ...
          >
            <GlassCard className="p-6 h-full flex flex-col justify-center hover:border-[hsl(235_86%_65%/0.2)] transition-colors">
              <div className="flex items-center gap-5">
                ...
                <div className="flex-1">
                  <h2 className="text-lg font-heading font-bold text-foreground">Join the TikUp Discord</h2>
                  <p className="text-sm text-muted-foreground mt-1">Get help, share ideas, and connect with other creators</p>
                </div>
                <ArrowRight size={18} className="text-muted-foreground group-hover:text-[hsl(235_86%_65%)] group-hover:translate-x-1 transition-all shrink-0" />
              </div>
            </GlassCard>
          </motion.a>
        </div>
        ...
        >
          <GlassCard className="p-6 relative overflow-hidden" style={{
            ...
            <div className="relative z-10 flex items-center gap-6">
              ...
              <Link to="/pro" className="flex items-center gap-2 px-6 py-3 rounded-xl bg-secondary text-secondary-foreground font-semibold text-sm hover:opacity-90 transition-opacity shrink-0">
