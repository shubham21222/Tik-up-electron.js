...
const presetConfigs: Record<string, PresetConfig> = {
  hype: {
    ...
    color: "350 90% 55%",
    features: [
      { name: "Gift Fireworks", description: "Explosive particle effects when big gifts land", overlayPath: "gift-firework", settingsPath: "/gift-firework", enabled: true },
      { name: "Gift Combo Counter", description: "Stacking combo counter for rapid gift chains", overlayPath: "gift-combo", settingsPath: "/gift-combo", enabled: true },
      { name: "Sound Alerts", description: "Custom sound effects triggered by gifts and follows", overlayPath: "tts", settingsPath: "/sounds", enabled: true },
      { name: "Like Burst Animation", description: "Heart explosion on like milestones", overlayPath: "like-alert", settingsPath: "/like-alerts", enabled: true },
      { name: "Top Supporters Board", description: "Live leaderboard of biggest gifters", overlayPath: "leaderboard", settingsPath: "/leaderboard", enabled: true },
      { name: "Gift Alert Banner", description: "Animated banner for every gift received", overlayPath: "gift-alert", settingsPath: "/actions", enabled: true },
    ],
  },
  gaming: {
    id: "gaming",
    ...
    color: "160 100% 45%",
    features: [
      { name: "Corner Gift Alerts", description: "Compact gift notifications in the corner", overlayPath: "gift-alert", settingsPath: "/actions", enabled: true },
      { name: "Viewer Count", description: "Live viewer number in a minimal badge", overlayPath: "viewer-count", settingsPath: "/viewer-count", enabled: true },
      { name: "Stream Timer", description: "Elapsed time counter for your session", overlayPath: "stream-timer", settingsPath: "/stream-timer", enabled: true },
      { name: "Chat Box", description: "Floating chat overlay on screen", overlayPath: "chat-box", settingsPath: "/chat-overlay", enabled: true },
      { name: "Webcam Frame", description: "Animated frame around your camera feed", overlayPath: "webcam-frame", settingsPath: "/webcam-frame", enabled: true },
  ...
  irl: {
    ...
    features: [
      { name: "Chat Box", description: "Floating chat overlay on screen", overlayPath: "chat-box", settingsPath: "/chat-overlay", enabled: true },
      { name: "Stream Timer", description: "How long you've been live", overlayPath: "stream-timer", settingsPath: "/stream-timer", enabled: true },
      { name: "Follower Goal", description: "Visual progress bar toward follower target", overlayPath: "follower-goal", settingsPath: "/goal-overlays", enabled: true },
      { name: "Social Rotator", description: "Rotating social media handles on screen", overlayPath: "social-rotator", settingsPath: "/social-rotator", enabled: true },
  ...
  talkshow: {
    ...
    color: "280 100% 65%",
    features: [
      { name: "Text-to-Speech", description: "Viewers' messages read aloud on stream", overlayPath: "tts", settingsPath: "/tts", enabled: true },
      { name: "Top Supporters Board", description: "Live leaderboard of your biggest fans", overlayPath: "leaderboard", settingsPath: "/leaderboard", enabled: true },
      { name: "Like Counter", description: "Big animated like counter on screen", overlayPath: "like-counter", settingsPath: "/like-counter", enabled: true },
      { name: "Custom Text", description: "Custom text banners and tickers", overlayPath: "custom-text", settingsPath: "/custom-text", enabled: true },
